        ...
        <div className="Section6">
            ...
            <div className="Section4 d-flex">
                <div className="Section6_3">
                        ...
                        <p className="Section6_heading2_1">In 1961, Paraquat was produced for commercial use to kill over 100 different types of crops. It remains one of the most frequently used herbicides in the world. A person can be poisoned by Paraquat if their skin is accidentally exposed to the chemicals or through accidental ingestion. If a concentrated version of it is used or a person is exposed to it for long periods, poisoning is more likely to occur. It can also poison a person through a rash, cuts, or sores on their skin. Lung damage can occur if Paraquat is inhaled.</p>
