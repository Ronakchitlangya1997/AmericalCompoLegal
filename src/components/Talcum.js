...
export function Talcum() {

    return (
        <div className="Section6">
            <div className="Section6_1">
                <img className="Section6_image" src="https://i.dailymail.co.uk/1s/2019/10/18/16/19891434-0-image-a-8_1571413811993.jpg" alt=""></img>
                <p className="Section6_heading">Talcum</p>
            </div>
            <div className="d-flex gap-4">
                <div className="Section6_2">
                    <div className="Section6_2_1">
                        <h3 className="Section6_heading1">Talcum Lawsuit</h3>
                        <p className="Section6_heading2">Are you seeking help in filing a Talcum powder lawsuit?</p>

                        <p className="Section6_heading2">NOW you can also claim, want to know how?</p>

                        <p className="Section6_heading2">Talcum powder lawsuit claims against the talcum powder manufacturers relate to mesothelioma and ovarian cancer or any other diseases due to the use of their talcum powder..</p>
            ...
            <div className="Section4 d-flex">
                <div className="Section6_3">
                        ...
                        <p className="Section6_heading2_1">Also used in Ceramics and Paints by Industrial Manufacturers. To make the talcum powder, companies mine TALC from the rock deposits to make it soft and fine by crushing, drying & mill.</p>
