...
export function Zantac() {

    return (
        <div className="Section6">
            <div className="Section6_1">
                <img className="Section6_image" src="https://live-production.wcms.abc-cdn.net.au/a02d002eadfcaab57257d053eecfec53?impolicy=wcms_crop_resize&cropH=1997&cropW=3000&xPos=0&yPos=111&width=862&height=575" alt=""></img>
                <p className="Section6_heading">Zantac</p>
            </div>
            <div className="d-flex gap-4">
                <div className="Section6_2">
                    <div className="Section6_2_1">
                        <h3 className="Section6_heading1">Zantac Lawsuit</h3>
                        <p className="Section6_heading2">Are you seeking help in filing Zantac lawsuit ?</p>

                        <p className="Section6_heading2">Have you or any of your loved ones faced complications due to the Zantac ? </p>

                        <p className="Section6_heading2">Now looking for the compensation help? You are at the right place.</p>
