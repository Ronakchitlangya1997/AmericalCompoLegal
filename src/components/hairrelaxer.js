...
export function Hairrelaxer() {

    return (
        <div className="Section6">
            <div className="Section6_1">
                <img className="Section6_image" src="https://americancompo.s3.ap-south-1.amazonaws.com/HairRelaxerHorizontal_v2.png" alt=""></img>
                <p className="Section6_heading">Hair Relaxer</p>
            </div>
            <div className="d-flex gap-4">
                <div className="Section6_2">
                    <div className="Section6_2_1">
                        <h3 className="Section6_heading1">Hair Relaxer Lawsuit</h3>
                        <p className="Section6_heading2">Are you a victim of a hair relaxer lawsuit and looking for legal assistance?</p>

                        <p className="Section6_heading2">Hair relaxers have been linked to severe scalp burns, hair loss, and other health issues.</p>

                        <p className="Section6_heading2">The manufacturers of these hair products may be liable for not disclosing the potential risks associated with their products.</p>
                ...
                <div className="Section6_3">
                        ...
                        <p className="Section6_heading2_1">Hair relaxers have been associated with serious health issues, including scalp burns, hair breakage, and hair loss.</p>

                        <p className="Section6_heading2_1">If you have suffered harm as a result of using a hair relaxer product, contact a lawyer to explore your legal options.</p>
